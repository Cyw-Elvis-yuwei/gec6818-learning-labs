...
- 项目名称：医路通——基于 GEC6818 和 LVGL 的联网智慧医疗自助服务终端。
- 项目目标：在 GEC6818 嵌入式 Linux 终端上完成联网医疗排队自助服务。
...
- 语言和系统：C、C11、Ubuntu 20.04、嵌入式 Linux、GEC6818。
...
| 目录 | 用途 |
| --- | --- |
| `board/clinic_terminal/` | GEC6818 正式 LVGL 医疗终端 |
