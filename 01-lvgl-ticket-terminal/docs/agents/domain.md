...
If the concept you need isn't in the glossary yet, either reconsider whether you are inventing language the project doesn't use, or note the gap for domain modeling.
